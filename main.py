...
TRANSLATIONS = {
    'uz': {
        ...
        'add_schedule_not_allowed': "❌ Dars jadvali faqat admin tomonidan qo'shiladi.",
    ...
    'ru': {
        ...
        'add_schedule_not_allowed': "❌ Расписание может добавить только администратор.",
    ...
    'kr': {
        ...
        'add_schedule_not_allowed': "❌ 시간표는 관리자만 추가할 수 있습니다.",
