...
if not os.path.exists(FONT_PATH):
    try:
        ...
        logging.info(" NanumGothic shrifti yuklanmoqda...")
...
WEATHER_RECOMMENDATIONS = {
    "Clear": {
        "uz": " Bugun havo ochiq. Sayr qilish uchun ajoyib kun!",
        "ru": " Сегодня ясно. Отличный день для прогулки!",
        "kr": " 오늘은 '은 날씨입니다. 산책하기 좋은 날이에요!"
    },
    "Clouds": {
        "uz": " Bugun havo bulutli. Salqin havo bilan ish kuningiz samarali o'tsin!",
        "ru": " Сегодня облачно. Пусть прохладная погода сделает ваш рабочий день продуктивным!",
        "kr": " 오늘은 흐린 날씨입니다. 시원한 날씨와 함께 즐거운 하루 되세요!"
    },
    "Rain": {
        "uz": " Bugun yomg'ir yog'moqda. Soyabon olishni unutmang!",
        "ru": " Сегодня идет дождь. Не забудьте взять зонтик!",
        "kr": " 오늘은 비가 옵니다. 우산 챙기는 것 잊지마세요!"
    },
    "Thunderstorm": {
        "uz": " Momaqaldiroq bo'lmoqda. Ehtiyot bo'ling!",
        "ru": " Гроза. 'удьте осторожны!",
        "kr": " 천'번개가 칩니다. 조심하세요!"
    },
    "Snow": {
        "uz": " Qor yog'moqda. Issiq kiyining!",
        "ru": " Идет снег. Одевайтесь теплее!",
        "kr": " 눈이 옵니다. 따뜻하게 입으세요!"
    },
    "Mist": {
        "uz": " Tuman tushgan. Haydovchilar ehtiyot bo'ling!",
        "ru": " Туман. 'одители, будьте осторожны!",
        "kr": " 안개가 끼었습니다. 운전자분들 조심하세요!"
    },
    "Fog": {
        "uz": " Tuman tushgan. Haydovchilar ehtiyot bo'ling!",
        "ru": " Туман. 'одители, будьте осторожны!",
...
TRANSLATIONS = {
    ...
    'ru': {
        ...
        'already_attended': " 'ы уже отмечались сегодня в филиале {branch}!",
...
async def admin_active_schedules(callback: types.CallbackQuery):
    ...
    try:
        ...
        for schedule_id, schedule in schedules.items():
            ...
            builder = InlineKeyboardBuilder()
            builder.row(
                InlineKeyboardButton(text=" O'zgartirish", callback_data=f"admin_edit_schedule_{schedule_id}"),
