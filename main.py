...
# --- XAVFSIZ VA BARQAROR LOKATSIYA HANDLERI (FAQAT FORWARD TEKSHIRILADI) ---
...
async def handle_location(message: types.Message):
    ...
    # 2. FAQAT FORWARDNI TEKSHIRAMIZ (Bu xavfsiz va 100% aniq)
    ...
    # 3. AGAR FORWARD BO'LMASA, ODATIY TEKSHIRUV DAVOM ETADI
    now_uzb = datetime.now(UZB_TZ)
