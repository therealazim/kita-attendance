...
“”“Shriftni asinxron ravishda yuklab olish (event loopni bloklamaydi)”””
...
logging.error(f”❌ Shrift yuklab olishda HTTP xato: {resp.status}”)
...
r = _requests.get(“https://github.com/google/fonts/raw/main/ofl/nanumgothic/NanumGothic-Regular.ttf”, timeout=30)
with open(FONT_PATH, “wb”) as f:
f.write(r.content)
logging.info(“✅ NanumGothic shrifti (sinxron) yuklandi”)
except Exception as e:
logging.warning(f”⚠️ Shrift sinxron yuklab bo’lmadi: {e}”)
...
logging.warning(f”⚠️ Nanum shrifti yuklanmadi: {e}”)
try:
...
logging.warning(f”⚠️ DejaVu shrifti ham topilmadi: {e2}”)
FONT_NAME = ‘Helvetica’
...
today = now.date()
if last_sent_date != today:  # Bir kunda faqat bir marta yuborish
...
async def main():
await download_font()  # Shriftni asinxron yuklab olish
